...
/*
 * outputs/test_spmp_ok_u0_rw1_x0_s0_sum1_match1.c
...
#if 1
    	cfg0 |= ((1 ? (PMP_R | PMP_W)  : 0) | (0 ? PMP_X : 0) | PMP_TOR | (0 ? SPMP_S : 0)) << 16;
#endif   
...
#if 1
    	cfg0 |= ((1 ? (PMP_R | PMP_W)  : 0) | (0 ? PMP_X : 0) | PMP_TOR | (0 ? SPMP_S : 0)) << 8;
#endif   
    	asm volatile ("csrw 0x1a0, %0 \n"
    	            :
    	            : "r"(cfg0)
